...
public class JsonSave
{
  ...
  /// <summary>
  /// Creates a file at the default save location with the provided name and data.
  /// Note, you can only replace, not update. idk why.
  /// </summary>
  /// <param name="fileName">The exact name of the file to create/update.</param>
  /// <param name="data">the Godot.Collections.Dictionary data to be parsed.</param>
